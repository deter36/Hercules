import { verifyPins } from './VAL-003-validation-20260914T015459Z-5daa2c-common.mjs';
...
const RUN = 'validation-20260914T015459Z-5daa2c';
const TESTED = '3172948a749eac19c17551b4e39624638f8835b6';
const ROOT = 'orchestration/validation/VAL-003-' + RUN + '-golden';
...
const task = {...read('orchestration/tasks/VAL-003.json'),validation_mode:'deterministic_replay',scenario_id:'HERC-GOLDEN-RUN-0001',start_state:{complete_state_path:'orchestration/validation/RS-001-golden-start-state.json'},rng:{seed:'HERC-GOLDEN-RUN-0001',algorithm:'SHA256_COUNTER_V1',policy:'HERC-RNG-v3'}};
const manifest = read('orchestration/project_state.json');
ensure(manifest.manifest_revision === 'e1-m0005', 'MANIFEST_CHANGED');
if (!CHECK) {
